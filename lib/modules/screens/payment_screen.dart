        ...
        child: BlocConsumer<CreditCardCubit, CreditCardState>(
            ...
            builder: (context, state) {
              return Scaffold(
                ...
                floatingActionButton: state.status == CreditCardStatus.loading
                    ? null
                    : _addButton(() {
                ...
                body: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          const EdgeInsets.only(left: 16, top: 32, bottom: 16),
                      child: Text(
                        "Your payment cards",
...
Widget _creditCard(
    CreditCard creditCard, VoidCallback setDefault, VoidCallback removeCredit) {
  return Padding(
